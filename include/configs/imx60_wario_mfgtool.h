...
#define CONFIG_MFGTOOL_MODE

/* IMP: Define the appropriate RAM size here */
#define CONFIG_SDRAM_SZ_256M
 ...
 */
/* BEN TODO */
#define CONFIG_SYS_MALLOC_LEN		(50 * 1024)
...
#if defined(CONFIG_SDRAM_SZ_512M)
#define PHYS_SDRAM_1_SIZE	(512 * 1024 * 1024)
#elif defined(CONFIG_SDRAM_SZ_256M)
