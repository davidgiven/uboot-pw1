...
void lpddr2_enter_lpm (void)
{
	while ((reg32_read(0x021b0404) & 0x10) == 0);
	...
	reg32_write(IOMUXC_SW_PAD_CTL_PAD_DRAM_SDQS0, 0x00000000);  // IOMUXC_SW_PAD_CTL_PAD_DRAM_SDQS0 - DSE=110
	reg32_write(IOMUXC_SW_PAD_CTL_PAD_DRAM_SDQS1, 0x00000000);  // IOMUXC_SW_PAD_CTL_PAD_DRAM_SDQS1 - DSE=110
	reg32_write(IOMUXC_SW_PAD_CTL_PAD_DRAM_SDQS2, 0x00000000);  // IOMUXC_SW_PAD_CTL_PAD_DRAM_SDQS2 - DSE=110
	reg32_write(IOMUXC_SW_PAD_CTL_PAD_DRAM_SDQS3, 0x00000000);  // IOMUXC_SW_PAD_CTL_PAD_DRAM_SDQS3 - DSE=110
	...
	reg32_write(IOMUXC_SW_PAD_CTL_GRP_ADDDS, 0x00000000);  // IOMUXC_SW_PAD_CTL_GRP_ADDDS - DSE=110
	...
	reg32_write(IOMUXC_SW_PAD_CTL_GRP_CTLDS, 0x00000000);  // IOMUXC_SW_PAD_CTL_GRP_CTLDS
}
